        ...
        <?php if (have_comments()) : ?>
            ...
            <?php
                ...
                function mytheme_comment($comment, $args, $depth)
                {
                    ...
                    ?>
                    <li>
                        <article id="comment-<?php comment_ID(); ?>" class="uk-comment <?php echo ($comment->user_id > 0) ? 'comment-byadmin' : '';?>">
                            ...
                            <div class="uk-comment-body">
                                ...
                                <?php if (comments_open()) : ?>
                                <p class="tm-js-reply"><a href="#" rel="<?php comment_ID(); ?>"><?php echo __('<i class="uk-icon-reply"></i> Reply', 'warp'); ?></a></p>
                                <?php endif; ?>
